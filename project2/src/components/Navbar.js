    ...
    return (
      <div className='w-full flex justify-between p-12 pb-0 items-center'>
        ...
        <div className='flex gap-16'>
          ...
          <a href='/list' className={props.location === 'list' ? 'font-bold text-black' : 'text-gray-500 hover:text-blue-900'}>MY LISTS</a>
          <a href='/zoom' className={props.location === 'zoom' ? 'font-bold text-black' : 'text-gray-500 hover:text-blue-900'}>LIVE SESSIONS</a>
        </div>
