  ...
  return (
    <div className='bg-footer-color text-white w-full flex p-12 pl-32'>
      ...
      <div className='w-1/5 flex flex-col gap-2'>
        ...
        <a href="/" className='text-xs'>About Dish Discovery</a>
        <a href="/" className='text-xs'>Privacy Policy</a>
        <a href="/" className='text-xs'>Terms of service</a>
      </div>
      <div className='w-1/5 flex flex-col gap-2'>
        <p className='font-bold'>Services</p>
        <a href="/recipes" className='text-xs'>Recipes</a>
        <a href="/assistant" className='text-xs'>Cooking help</a>
        <a href="/addrecipe"  className='text-xs'>Add Recipe</a>
      </div>
      <div className='w-1/5 flex flex-col gap-2'>
